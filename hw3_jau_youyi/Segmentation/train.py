...
def main():
    ...
    parser.add_argument('--fileList', default='/datasets/cse152-252-sp20-public/hw3_data/VOCdevkit/VOC2012/ImageSets/Segmentation/train.txt', help='list of training images' )
    # parser.add_argument('--fileListVal', default='/data/datasets/cs252csp19-public/VOCdevkit/VOC2012/ImageSets/Segmentation/trainval.txt', help='list of validation images' )
    parser.add_argument('--fileListTest', default='/datasets/cse152-252-sp20-public/hw3_data/VOCdevkit/VOC2012/ImageSets/Segmentation/val.txt', help='list of validation images' )
